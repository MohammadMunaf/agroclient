...
export default function ProductList() {
    ...
    const [mp, setmp] = useState(new Map([
        ...
        ["Tshirts", { BackgroundColor: 'white', Color: 'rgb(82, 81, 81)' }],
    ]));
                    ...
                    <div className='sideBar'>
                        <div className='catogory1' style={{ textAlign: "left" }}>
                            ...
                            <button
                                ...
                                style={{ backgroundColor: mp.get("Shirts").BackgroundColor, color: mp.get("Shirts").Color }}
                            >
                                <CandlestickChartIcon style={{ marginBottom: '-5px', width: '2em' }} />
                                Shirts
                            </button>
                            <button
                                onClick={() => updateButtonValue("Tshirts")}
                                style={{ backgroundColor: mp.get("Tshirts").BackgroundColor, color: mp.get("Tshirts").Color }}>
